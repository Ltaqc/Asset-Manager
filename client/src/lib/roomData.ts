...
export const ROOM_DATA: Record<RoomCategory, RoomInfo> = {
  ...
  "Стандарт с раздвижной двуспальной кроватью и балконом": {
    ...
    prices: { 6: 4600, 7: 5700, 8: 5700, 9: 4600 },
    description: "Тёплые природные текстуры, мягкий свет и раздвижная двуспальная кровать задают ритм неспешного отдыха вдвоём. Балкон открывает утреннюю тишину курорта, а продуманная планировка сохраняет ощущение простора даже в компактном пространстве.",
    area: 16,
