...
export const ROOM_DATA: Record<RoomCategory, RoomInfo> = {
  ...
  "Стандарт с раздвижной двуспальной кроватью и балконом": {
    ...
    prices: { 6: 4600, 7: 5700, 8: 5700, 9: 4600 },
    description: "Функциональный номер с раздвижной двуспальной кроватью и балконом. Продуманная планировка позволяет гибко использовать пространство, сохраняя лёгкость и комфорт курортного размещения.",
    area: 16,
