        ...
        <div className="prose prose-sm max-w-none space-y-8 text-sm text-foreground leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>Передача менеджеру по электронной почте и через мессенджер Telegram для обработки заявки.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-base font-semibold mb-3">8. Передача данных третьим лицам</h2>
            <p>В рамках обработки заявок на бронирование данные (имя, телефон, параметры бронирования) передаются:</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong>Telegram</strong> (Telegram Messenger Inc.) — для уведомления менеджера отеля о новой заявке;</li>
              <li><strong>Почтовый сервис SMTP</strong> — для направления уведомления на адрес электронной почты менеджера.</li>
            </ul>
            <p className="mt-2 text-muted-foreground">Данные не передаются рекламным агентствам, брокерам данных или иным третьим лицам в коммерческих целях.</p>
          </section>
