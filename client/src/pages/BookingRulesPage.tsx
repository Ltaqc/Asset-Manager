    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-10 md:py-16 max-w-3xl">
        ...
        <div className="space-y-8 text-sm text-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-semibold mb-3 pb-2 border-b border-border">1. Порядок оформления предварительной заявки</h2>
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              <li>Предварительная заявка на бронирование оформляется через форму на сайте или по телефону.</li>
              <li>Отправка формы на сайте не является подтверждением бронирования.</li>
              <li>Бронирование считается подтверждённым только после подтверждения менеджером по телефону или в сообщении.</li>
              <li>Калькулятор на сайте рассчитывает предварительную стоимость проживания. Окончательная стоимость и наличие номеров подтверждаются менеджером.</li>
              <li>В сезоне 2026 года предварительные заявки принимаются на даты проживания с 1 июня по 20 августа включительно.</li>
            </ul>
          </section>
